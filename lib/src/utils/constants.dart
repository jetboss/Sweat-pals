class AppConstants {
  static const String appTitle = 'Sweat Pals';
  
  static const List<String> motivationalQuotes = [
    "We're sweating it out together!",
    "Your sweat pal believes in you!",
    "Together we're unstoppable!",
    "Every step counts when we're in this together!",
    "Stronger together, one workout at a time.",
    "Pals who sweat together, stay together!",
    "You've got this, and I've got you!",
    "Small progress is still progress. Let's keep going!",
  ];
